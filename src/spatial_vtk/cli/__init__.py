...
def _add_metrics_commands(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    outputs.add_argument(
        ...
        default=None,
        help=(
            "Custom downstream metric output directory. When omitted, configured output paths are used. "
...
def _add_spatial_commands(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    derived.add_argument("--outputs", metavar="KEYS", default="all", help="Comma-separated derived output keys to build. Defaults to all optional spatial derived outputs.")
...
def _add_figure_io_arguments(parser: argparse.ArgumentParser, spec: PlotCommand, *, include_map_options: bool) -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Prefer config-backed defaults and named table flags such as --event-table, --station-table, "
            "--events, --stations, or --records when this command lists them. "
