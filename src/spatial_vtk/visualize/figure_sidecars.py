...
def _figure_sidecar_status_row(metadata_path: Path, metadata: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "plot_table_role": metadata.get("plot_table_role", ""),
        "source_table_role": metadata.get("source_table_role", ""),
        "event_centered": metadata.get("event_centered", ""),
        "event_centering": metadata.get("event_centering", ""),
