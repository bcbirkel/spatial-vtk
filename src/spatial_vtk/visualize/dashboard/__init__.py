...
_EXPORT_MODULES = {
    ...
    "display_dashboard_preparation_result": "spatial_vtk.visualize.dashboard.export",
    ...
    "dashboard_chart_columns_or_message": "spatial_vtk.visualize.dashboard.contracts",
    "dashboard_empty_rows_message": "spatial_vtk.visualize.dashboard.contracts",
    "dashboard_missing_columns_message": "spatial_vtk.visualize.dashboard.contracts",
